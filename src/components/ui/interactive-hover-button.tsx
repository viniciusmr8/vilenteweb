  ...
  return (
    ...
    >
      <span className={cn(
        ...
        isBack ? "-translate-x-1 group-hover:-translate-x-12" : "translate-x-1 group-hover:translate-x-12"
      )}>
        {text}
      </span>
      <div className={cn(
        ...
        isBack ? "-translate-x-12 group-hover:translate-x-1 group-hover:opacity-100" : "translate-x-12 group-hover:-translate-x-1 group-hover:opacity-100"
      )}>
        {isBack && <Icon />}
        <span>{text}</span>
        {!isBack && <Icon />}
